...
<head>
    ...
    <title>Add MHPs Dashboard</title>
            ...
            <div id="main-content">
                <div class="page-heading">
                    <div class="page-title">
                        <div class="row">
                            <div class="col-12 col-md-6 order-md-1 order-last">
                                <h3>Add Mental Health Professionals</h3>
                            </div>
                        </div>
                    </div>
                    <section class="section">
                        <div class="card">
                            <div class="card-body">
                            <form class="form" method="post" action="process-add-mhp.php" enctype="multipart/form-data">                                    <div class="row">

                                    <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                <label for="profilepic">Image</label>
                                                <input type="file" id="profilepic" class="form-control" name="photo" placeholder="profilepic" required>                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="email" id="email" class="form-control" placeholder="City" name="email">
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                <label for="License">License Number</label>
                                                <input type="text" id="license" class="form-control" name="license" placeholder="License Number" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                <label for="specialization">Specialization</label>
                                                <input type="text" id="company-column" class="form-control" name="specialization" placeholder="Specialization" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                <label for="email-id-column">Years of experience</label>
                                                <input type="number" id="yos" class="form-control" name="yos" placeholder="Years Of experience" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="town" class="form-control" name="town" placeholder="Town" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                <label for="town">Building</label>
                                                <input type="text" id="building" class="form-control" name="building" placeholder="Building" required>
                                            </div>
                                        </div>
